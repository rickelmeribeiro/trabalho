...
if (isset($Dados) && !empty($Dados)) {
    ...
    $nome = isset($Dados['nome_contato']) ? addslashes($Dados['nome_contato']) : '';
    $numero = isset($Dados['numero_contato']) ? addslashes($Dados['numero_contato']) : '';


    $retornoInsert = addContato($nome, $numero);
